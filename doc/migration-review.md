...
本次复盘最初运行于 Node `v25.3.0`、npm `11.9.0`。仓库现固定为该版本；随后在 Node `v25.3.0`、npm `11.9.0` 下完成完整质量门，包含类型检查、153 个单元/组件测试、13 个服务端集成、4 个 Chromium E2E、3 个视觉回归和生产构建，全部通过。
