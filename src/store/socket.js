...
class LiveLobby {
  constructor(store) {
    ...
    this._isAlive = true;
    this._store = store;
    this._lobby = useLobbyStore(pinia);
    this._pingInterval = 3 * 1000; // 30 seconds between pings
    this._pingTimer = null;
    this._reconnectTimer = null;
  ...
  _open() {
    ...
    if (this._socket === null) {
      this._lobby.setIsReconnecting(true);
